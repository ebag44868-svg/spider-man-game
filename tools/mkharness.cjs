...
export const T = {
  ...
  M_LIGHT, M_HEAVY, M_SHOVE, M_LAUNCH, meleeBranch, get mChainT(){ return mChainT; }, get mBuf(){ return mBuf; }, M_CHAIN_T, CHARGE_FULL, PARRY_WIN, PARRY_POST, ROLL_TIME, ROLL_IFR, ROLL_STAM, ROLL_BURST, ROLL_SPEED, EXEC_TIME, STAG_TIME, POST_DECAY,
