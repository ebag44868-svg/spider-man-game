...
export const T = {
  ...
  MOVE_SPEED, SPRINT_MULT, FALL_TIERS, HEROES, applyHero, get hero(){ return hero; },
  AIR_MAX, AIR_HITS, AIR_FALL, DOWN_TIME, AIR_RISE, AIR_HOVER, AIR_KEEP, AIR_LIFT, AIR_GRAV, AIR_HOLD, AIR_SIDE, AIR_COMBO_G, get airComboT(){ return airComboT; }, launchEnemy,
  ...
  CHARGE_MIN, CHARGE_FULL, MELEE_AIM_R, FALL_MIN_V, FALL_TIERS, get fallTopY(){ return fallTopY; }, setHp(v){ hp = v; invuln = 0; regenWait = 0; regenT = 0; deadT = 0; },
  ...
  M_LIGHT, M_HEAVY, M_SHOVE, M_LAUNCH, meleeBranch,
  get combo(){ return combo; }, setCombo(v){ combo = v; comboT = 1.8; }, comboTier, COMBO_TIERS, COMBO_STOP, COMBO_ULT, COMBO_ULT_HIT, get hitStopNow(){ return hitStop; }, get mChainT(){ return mChainT; }, get mBuf(){ return mBuf; }, M_CHAIN_T, CHARGE_FULL, PARRY_WIN, PARRY_POST, ROLL_TIME, ROLL_IFR, ROLL_STAM, ROLL_BURST, ROLL_SPEED, EXEC_TIME, STAG_TIME, POST_DECAY,
