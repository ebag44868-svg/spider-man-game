...
function doMeleeHit(a) {
  ...
  if (best.stag <= 0) {
    ...
    const up = spec.launch || spec.kb * (a.heavy ? 0.42 : 0.2);
    best.knock.add(_mh.multiplyScalar(spec.kb).setY(up));
  }
