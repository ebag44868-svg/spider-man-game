...
function attachWeb(point) {
  ...
  web = { a: point.clone(), len: d, base: d, t: 0, side: sideOf(point) };
  tutSwings++;                     // 튜토리얼 진행도
  hasDash = true;
  armPulse = 0.35;
  sfxThwip();
